...
import { Mail, Lock, Eye, EyeOff, UserPlus, Loader2, Box } from "lucide-react";
...
export default function SignupPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.success("Account created! Welcome to 3DForge 🎉");
            navigate("/dashboard");
        } catch (error) {
            const errorMessages = {
            ...
            <div className="min-h-[85vh] flex items-center justify-center px-4">
                ...
                <div className="w-full max-w-md relative z-10 animate-slide-up">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-500 dark:text-dark-400">Start generating 3D models with 5 free credits</p>
                    </div>
